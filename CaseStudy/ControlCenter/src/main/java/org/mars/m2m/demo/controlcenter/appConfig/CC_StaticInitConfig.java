...
public class CC_StaticInitConfig {
    ...
    public static Integer SIZE_OF_SUBTEAM = 3;//determines the number of attackers assigned to one threat
    ...
    public static AtomicInteger CURRENT_SIMULATION_TIME = new AtomicInteger(1);
