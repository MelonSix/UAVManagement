 ...
 * @author AG BRIGHTER
 */
public class AnalysisUI_BarChart
{
    private static Logger logger = (Logger) LoggerFactory.getLogger(AnalysisUI_BarChart.class);
    ...
    private static Scene creatScene()
    {
        ...
        Map<Integer, Integer> gData = ChartDatastore.getMessagesPerSecondData_broadcast();
