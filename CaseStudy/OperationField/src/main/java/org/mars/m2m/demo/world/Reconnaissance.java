...
/**
 *This class is used to keep the data gathered from the environment or world view
 * @author AG BRIGHTER
 */
public class Reconnaissance implements KnowledgeAwareInterface
{
    private static final Logger logger = (Logger) LoggerFactory.getLogger(Reconnaissance.class);
    ...
    /**
     * 
     * @param kb is the knowledge of the sensed from environment
     */
