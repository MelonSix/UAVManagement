 ...
 * @author AG BRIGHTER
 */
public class FlightControlClient extends AbstractDevice
{
   private Logger log = (Logger) LoggerFactory.getLogger(FlightControlClient.class);
   ...
   public synchronized void StartDevice()
   {
       if(canDeviceStart.getAndSet(false))
       {
           ...
           //attach instance
           initializer.setInstancesForObject(12204, flightControl);
           initializer.setInstancesForObject(3, device);
           List<ObjectEnabler> enablers = initializer.create(12204,3);
