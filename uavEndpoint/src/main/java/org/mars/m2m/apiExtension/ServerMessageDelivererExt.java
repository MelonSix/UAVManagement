...
/**
 * The ServerMessageDelivererExt delivers requests to corresponding resources and
 responses to corresponding requests.
 */
public class ServerMessageDelivererExt implements MessageDeliverer {

	private final static Logger LOGGER = Logger.getLogger(ServerMessageDelivererExt.class.getCanonicalName());
	 ...
	 */
	public ServerMessageDelivererExt(Resource root) {
		this.root = root;
	}
	...
	public void deliverRequest(final Exchange exchange) {
		...
		final ObjectResourcePatch resource = (ObjectResourcePatch) findResource(path);//modification
		if (resource != null) {
