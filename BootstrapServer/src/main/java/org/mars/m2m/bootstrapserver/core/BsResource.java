...
public class BsResource extends CoapResource {

    private static final Logger LOG = LoggerFactory.getLogger(BsResource.class);
    ...
    public BsResource(BootstrapStore store) {
        // set resource identifier
        super("bs");
        
        // set display name
        getAttributes().setTitle("Bootstrap Resource");
